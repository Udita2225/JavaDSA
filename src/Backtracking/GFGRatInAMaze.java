...
/*
Rat in a Maze
Difficulty: MediumAccuracy: 35.75%Submissions: 406K+Points: 4Average Time: 25m
...
/*
class Solution {
    public void mazePath(int sr,int sc, int er, int ec, int[][] maze, boolean[][] isValid, ArrayList<String> ans, String str){
    ...
    isValid[sr][sc] = true;
    //Down
    mazePath(sr+1,sc,er,ec,maze,isValid,ans,str+"D");
    //Left
    mazePath(sr,sc-1,er,ec,maze,isValid,ans,str+"L");
    //Right
    mazePath(sr,sc+1,er,ec,maze,isValid,ans,str+"R");
    //Up
    mazePath(sr-1,sc,er,ec,maze,isValid,ans,str+"U");
    isValid[sr][sc] = false;
    }
    public ArrayList<String> ratInMaze(int[][] maze) {
        ...
        mazePath(0,0,n-1,n-1,maze,isValid,ans,"");
        return ans;
    }
}
*/
