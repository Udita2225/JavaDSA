...
public class LeetCode430FlattenAMultilevelDLL {
...
nodes. These child lists may have one or more children of their own, and so on, to produce a multilevel data structure
...
class Solution {
    public Node flatten(Node head) {
        Node temp =head;
        while(temp!=null){
            Node t = temp.next;//Aage waali NODE hum kho naa den
            if(temp.child != null){
