package OOPS;
//Addition of two fractions and storing it in a fraction
public class AdditionOfTwoFractions {
    public static Fraction add(Fraction f1, Fraction f2 ){//Because hum fraction return karke fraction me hi store kar rahe hain
