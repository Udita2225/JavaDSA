...
real-time. This helps to determine cut-off marks for interviews and admissions dynamically as new applicants submit their
scores.
...
*/
public class LeetCode703KthLargestInAStream {
/*
class KthLargest {
    int k;
